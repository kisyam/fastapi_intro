...
BOOKS = [
    Book(1, "Computer Science Pro", "codingwithposea", "A very nice book", 5, 2030),
    Book(2, "Be Fast with FastAPI", "codingwithposea", "A great book", 5, 2030),
    Book(3, "Master Endpoints", "codingwithposea", "A awesome book", 5, 2029),
...
)  # query parameter -> not interfere with the above function
